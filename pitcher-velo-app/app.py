...
if color_columns:
    st.markdown(
        """
        <style>
        .dk-table th:nth-child(2), .dk-table td:nth-child(2) { color: #E03A2F; }
        .dk-table th:nth-child(3), .dk-table td:nth-child(3) { color: #2979FF; }
        .dk-table th:nth-child(4), .dk-table td:nth-child(4) { color: #1FB59A; }
        </style>
        """,
        unsafe_allow_html=True,
    )
